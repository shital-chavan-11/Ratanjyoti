		...
		>
			...
			<Box sx={{ maxWidth: 500, width: '100%', p: 3, boxShadow: 3, borderRadius: 2 }}>
				...
				<FormControl fullWidth margin="normal">
					...
					>
						<MenuItem value="Blue Sapphire (Neelam)">Blue Sapphire (Neelam)</MenuItem>
					</Select>
				</FormControl>
				...
				<FormControl fullWidth margin="normal">
					...
					>
						<MenuItem value="Ceylon (Srilanka)">Ceylon (Srilanka)</MenuItem>
						<MenuItem value="Kashmir ( India )">Kashmir ( India )</MenuItem>
					</Select>
				</FormControl>
