...
function RudrakshaDetails() {
	...
	const API_URL = ' https://ratanjyoti.onrender.com/product/rudraksha/Natural  15 Mukhi Rudraksha Savar (Nepali)/';
					...
					<Grid item xs={12} md={6}>
						<CardContent>
							...
							<Typography variant="body1" mt={2}>
								The Natural 15 Mukhi Rudraksha is a rare and powerful bead associated with Lord Shiva
								and Pashupatinath. This sacred Rudraksha is revered for its ability to foster
								unconditional love, emotional healing, and spiritual growth. Known for resonating with
								the Anahata Chakra (Heart Chakra), it enhances self-awareness, balances emotions, and
								strengthens the connection with the divine. Its divine energy promotes mental clarity,
								inner peace, and harmony in life. The 15 Mukhi Rudraksha is ideal for those seeking to
								heal past wounds and cultivate a more profound sense of compassion.
