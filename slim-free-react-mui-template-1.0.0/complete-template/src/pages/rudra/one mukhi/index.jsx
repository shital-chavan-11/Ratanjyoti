...
function RudrakshaDetails() {
	...
	const API_URL = ' https://ratanjyoti.onrender.com/product/rudraksha/Natural  1 Mukhi Rudraksha Savar (Nepali)/';
					...
					<Grid item xs={12} md={6}>
						<CardContent>
							...
							<Typography variant="body1" mt={2}>
								The 1 Mukhi Rudraksha is a rare and sacred bead that embodies Lord Shiva&apos;s supreme
								consciousness. This divine Rudraksha enhances spiritual awareness, deepens meditation,
								and brings mental clarity. Revered for its ability to remove obstacles and promote inner
								peace, it is ideal for those seeking enlightenment and self-realization. Resonating with
								the Sahasrara Chakra (Crown Chakra), it aligns the wearer with higher cosmic energies,
								fostering balance and divine connection.
