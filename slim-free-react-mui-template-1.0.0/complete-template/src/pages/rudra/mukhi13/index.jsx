...
function RudrakshaDetails() {
	...
	const API_URL = ' https://ratanjyoti.onrender.com/product/rudraksha/Natural  13 Mukhi Rudraksha Savar (Nepali)/';
					...
					<Grid item xs={12} md={6}>
						<CardContent>
							...
							<Typography variant="body1" mt={2}>
								The original 13 Mukhi Rudraksha symbolizes attraction, success, and creativity, blessed
								by Lord Indra and Kamadeva. This powerful bead enhances charm, confidence, and the
								ability to influence others, making it ideal for those seeking prosperity and
								recognition. Known for its divine energy, it fosters mental clarity, emotional balance,
								and personal magnetism. This Rudraksha bestows personal growth and spiritual elevation
								blessings, serving as a sacred symbol of abundance and power.
