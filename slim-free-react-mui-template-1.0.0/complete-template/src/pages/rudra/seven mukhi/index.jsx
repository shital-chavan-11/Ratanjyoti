...
function RudrakshaDetails() {
	...
	const API_URL = ' https://ratanjyoti.onrender.com/product/rudraksha/Natural  7 Mukhi Rudraksha Savar (Nepali)/';
					...
					<Grid item xs={12} md={6}>
						<CardContent>
							...
							<Typography variant="body1" mt={2}>
								The 7 Mukhi Rudraksha is a revered spiritual bead with immense significance in Vedic
								astrology and spiritual practices. This sacred bead is associated with Goddess Lakshmi,
								the goddess of wealth and prosperity, and is believed to bestow blessings of financial
								stability, success, and abundance. It is especially favored by business professionals
								and those seeking growth in their material life. The natural 7 Mukhi Rudraksha is known
								for its spiritual significance and transformative benefits, offering the wearer
								blessings of prosperity, health, and success.
