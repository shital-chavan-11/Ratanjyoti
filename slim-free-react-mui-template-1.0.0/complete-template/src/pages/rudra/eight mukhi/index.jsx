...
function RudrakshaDetails() {
	...
	const API_URL = ' https://ratanjyoti.onrender.com/product/rudraksha/Natural  8 Mukhi Rudraksha Savar (Nepali)/';
					...
					<Grid item xs={12} md={6}>
						<CardContent>
							...
							<Typography variant="body1" mt={2}>
								The Natural 8 Mukhi Rudraksha symbolizes wisdom, success, and divine protection,
								representing Lord Ganesha—the remover of obstacles. This rare and powerful bead
								establishes a strong connection between the physical and spiritual realms, enhancing
								inner strength, confidence, and the ability to overcome challenges. It is highly revered
								for boosting focus, mental clarity, and intellectual abilities, bringing harmony and
								balance to life. Whether worn as a pendant or kept as a sacred talisman, this Rudraksha
								offers divine blessings for personal and professional growth.
								<Typography>Beej Mantra: ॐ हूं नमः</Typography>
							</Typography>
