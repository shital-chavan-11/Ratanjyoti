...
function RudrakshaDetails() {
	...
	const API_URL = ' https://ratanjyoti.onrender.com/product/rudraksha/Natural  4 Mukhi Rudraksha Savar (Nepali)/';
					...
					<Grid item xs={12} md={6}>
						<CardContent>
							...
							<Typography variant="body1" mt={2}>
								The 4 Mukhi Original Rudraksha Beads is a highly revered bead with an ancient lineage.
								It embodies the divine energies of the four Vedas and is a symbol of wisdom, intellect,
								and spiritual growth. Known for its profound connection to knowledge and creativity, the
								natural 4 Mukhi Rudraksha is believed to awaken the power of speech, enhance logical
								thinking, and strengthen mental clarity. It is ideal for those seeking to unlock their
								potential in communication, self-expression, and intellectual pursuits.
