...
function RudrakshaDetails() {
	...
	const API_URL = ' https://ratanjyoti.onrender.com/product/rudraksha/Natural  12 Mukhi Rudraksha Savar (Nepali)/';
					...
					<Grid item xs={12} md={6}>
						<CardContent>
							...
							<Typography variant="body1" mt={2}>
								The 12 Mukhi Natural Certified Rudraksha symbolizes radiance, leadership, and vitality,
								blessed by Lord Surya—the Sun God. This powerful bead instills confidence, strength, and
								authority, empowering the wearer to lead with courage and clarity. Known for its
								transformative energy, it enhances focus, decision-making, and inner balance. This
								Rudraksha bestows divine blessings for personal and spiritual advancement, making it
								ideal as a pendant or a cherished sacred symbol.
								<Typography>Beej Mantra: ॐ क्रौं क्षौं रौं नमः</Typography>
							</Typography>
