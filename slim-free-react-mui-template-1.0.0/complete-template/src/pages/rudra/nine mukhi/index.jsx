...
function RudrakshaDetails() {
	...
	const API_URL = ' https://ratanjyoti.onrender.com/product/rudraksha/Natural  9 Mukhi Rudraksha Savar (Nepali)/';
					...
					<Grid item xs={12} md={6}>
						<CardContent>
							...
							<Typography variant="body1" mt={2}>
								The Natural 9 Mukhi Rudraksha symbolizes power, protection, and spiritual
								transformation, representing Goddess Durga—the embodiment of divine energy. This sacred
								and rare bead enhances courage, fearlessness, and resilience, helping the wearer
								overcome obstacles and adversities. It is highly revered for its ability to balance
								emotions, strengthen mental clarity, and promote spiritual growth. Whether worn as a
								pendant or kept as a sacred talisman, this Rudraksha offers divine blessings for
