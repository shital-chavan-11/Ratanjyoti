...
function RudrakshaDetails() {
	...
	const API_URL = ' https://ratanjyoti.onrender.com/product/rudraksha/Natural  10 Mukhi Rudraksha Savar (Nepali)/';
					...
					<Grid item xs={12} md={6}>
						<CardContent>
							...
							<Typography variant="body1" mt={2}>
								The 10 Mukhi Original Rudraksha is a symbol of divine protection and spiritual strength,
								blessed by Lord Vishnu—the preserver of the universe. This powerful bead shields the
								wearer from negative energies, evil forces, and obstacles, fostering a sense of security
								and stability. It is highly revered for enhancing focus, mental clarity, and emotional
								balance. Whether worn as a pendant or kept as a sacred charm, this Rudraksha offers
								divine blessings for overall well-being and success.
