...
function RudrakshaDetails() {
	...
	const API_URL = ' https://ratanjyoti.onrender.com/product/rudraksha/Natural  6 Mukhi Rudraksha Savar (Nepali)/';
					...
					<Grid item xs={12} md={6}>
						<CardContent>
							...
							<Typography variant="body1" mt={2}>
								The 6 Mukhi Rudraksha is a rare and powerful bead with deep spiritual and material
								significance. Revered in Hindu tradition, this sacred bead is believed to offer divine
								blessings, prosperity, and enlightenment to its wearer. The natural 6 Mukhi Rudraksha
								represents Lord Kartikeya, the son of Lord Shiva, and is associated with control over
								the mind and emotions. It is a revered choice for those seeking spiritual growth,
								self-control, and the removal of obstacles in life.
								<Typography>Beej Mantra: ॐ ह्रीं हुं नमः</Typography>
							</Typography>
