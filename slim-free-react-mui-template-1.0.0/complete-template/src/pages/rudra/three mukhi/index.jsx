...
function RudrakshaDetails() {
	...
	const API_URL = ' https://ratanjyoti.onrender.com/product/rudraksha/Natural  3 Mukhi Rudraksha Savar (Nepali)/';
					...
					<Grid item xs={12} md={6}>
						<CardContent>
							...
							<Typography variant="body1" mt={2}>
								The 3 Mukhi Original Rudraksha Beads is a sacred and powerful bead known for its
								transformative spiritual properties. Representing the divine trinity of Brahma, Vishnu,
								and Maheshwar, this bead radiates harmony, balance, and divine blessings. It is revered
								for its ability to help burn away past karmic impressions, making way for a new
								spiritual path. The natural 3 Mukhi Rudraksha enhances mental clarity, strengthens the
								aura, and provides emotional stability, supporting the wearer in their journey towards
								spiritual enlightenment.
								<Typography>Beej Mantra: ॐ क्लीन नमः</Typography>
							</Typography>
