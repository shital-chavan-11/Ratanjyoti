					...
					<Grid item xs={12} md={6}>
						<CardContent>
							...
							<Typography variant="body1" mt={2}>
								The natural 2 Mukhi Rudraksha represents the divine union of Lord Shiva and Goddess
								Parvati, symbolizing harmony, unity, and balance. This sacred bead fosters strong
								relationships, emotional stability, and inner peace. Sourced from Nepal, it is revered
								for promoting love, understanding, and overall well-being. Resonating with the
								Swadhisthana Chakra (Sacral Chakra), it enhances emotional healing and supports
								spiritual growth.
