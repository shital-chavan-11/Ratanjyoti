...
function RudrakshaDetails() {
	...
	const API_URL = 'http://127.0.0.1:8000/product/rudraksha/ Natural  14 Mukhi Rudraksha Savar (Nepali)/';
					...
					<Grid item xs={12} md={6}>
						<CardContent>
							...
							<Typography variant="body1" mt={2}>
								The Natural 14 Mukhi Rudraksha, also called the "Divine Jewel," is a rare and powerful
								bead blessed by Lord Hanuman. This sacred Rudraksha is revered for its ability to
								instill courage, strength, and protection. Known for activating the Ajna Chakra (third
								eye), it sharpens intuition and enhances decision-making skills. Its divine energy
								brings fearlessness, mental clarity, and stability, symbolizing spiritual mastery and
								physical resilience. This Pure Rudraksha Beads also helps overcome obstacles and
