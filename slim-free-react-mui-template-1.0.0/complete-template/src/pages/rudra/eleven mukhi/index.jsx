...
function RudrakshaDetails() {
	...
	const API_URL = ' https://ratanjyoti.onrender.com/product/rudraksha/Natural  11 Mukhi Rudraksha Savar (Nepali)/';
					...
					<Grid item xs={12} md={6}>
						<CardContent>
							...
							<Typography variant="body1" mt={2}>
								The Natural 11 Mukhi Rudraksha symbolizes strength, devotion, and divine protection,
								blessed by Lord Hanuman—the embodiment of fearlessness and unwavering faith. This sacred
								bead empowers the wearer with resilience, confidence, and mental clarity while shielding
								against negative influences. It is highly revered for enhancing spiritual discipline,
								focus, and willpower. This Rudraksha bestows divine blessings for personal and spiritual
								advancement, making it ideal as a pendant or a cherished sacred symbol
								<Typography>Beej Mantra: ॐ ह्रीं हूं नमः</Typography>
							</Typography>
