...
class AddToCartView(APIView):
    ...
    def post(self, request):
        ...
        # Determine product and filter field
        ...
        cart_item, created = CartItem.objects.get_or_create(user=request.user, defaults={'quantity': quantity}, **filter_kwargs)
...
class DecreaseQuantityView(APIView):
    ...
    def post(self, request):
        ...
        return Response({'message': 'Quantity decreased or item removed'}, status=status.HTTP_200_OK)
